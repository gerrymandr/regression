...
save(c.d.model.ler, c.r.model.ler, c.d.model.bym, 
     c.r.model.bym, c.d.sp.sglmm.fit, c.r.sp.sglmm.fit, 
...
#sglmm
d.sglmm.mspe <- mean((d.pred.sglmm - d.actual)^2)
...
#sglmm
r.sglmm.mspe <- mean((r.pred.sglmm - r.actual)^2)
