...
ballot_by_prec <- ggplot()+ 
  ...
  scale_fill_gradient2(midpoint = mean(ball_dat$SJR2.Yes/(ball_dat$SJR2.Yes + ball_dat$SJR2.No)),low = "red", high = "navyblue")
