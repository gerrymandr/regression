...
Need to eliminate the islands with neighbors
```{r}
...
c.d.model.ler <- S.CARleroux(formula=d.form, data=con_shp@data,
                             family="poisson", W=W_mat_con, burnin=20000, n.sample=120000, thin=10)

c.r.model.ler <- S.CARleroux(formula=r.form, data=con_shp@data,
                             family="poisson", W=W_mat_con, burnin=20000, n.sample=120000, thin=10)
...
c.d.model.bym <- S.CARbym(formula=d.form, data=con_shp@data,
                             family="poisson", W=W_mat_con, burnin=20000, n.sample=120000, thin=10)

c.r.model.bym <- S.CARbym(formula=r.form, data=con_shp@data,
                             family="poisson", W=W_mat_con, burnin=20000, n.sample=120000, thin=10)
...
c.d.sp.sglmm.fit <- sparse.sglmm(formula = d.form,data=con_shp@data, family = poisson, A = W_mat_con,
                             verbose = TRUE) #tune = list(sigma.s = 0.02)

c.r.sp.sglmm.fit <- sparse.sglmm(formula = r.form,data=con_shp@data, family = poisson, A = W_mat_con,
                             verbose = TRUE) #tune = list(sigma.s = 0.02)
