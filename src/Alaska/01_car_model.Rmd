...
#linear model
mean((c.d.resid.model)^2)
#glm
mean((c.d.resid.glm)^2)
#bym
mean((d.pred.bym-d.actual)^2)
#leroux
mean((d.pred.ler-d.actual)^2)

#### Republican Prediction:
#linear model
mean((c.r.resid.model)^2)
#glm
mean((c.r.resid.glm)^2)
#bym
mean((r.pred.bym-r.actual)^2)
#leroux
mean((r.pred.ler-r.actual)^2)
