...
length(which(co_v_table_glm[,2] > co_v_table_glm[,3])) #predicts 40
...
sum(class_act == class_lm, na.rm=T) #54 correct
...
sum(class_act == class_glm, na.rm=T) #57 correct
...
sum(class_act == class_colm, na.rm=T) #55 correct
...
sum(class_act == class_coglm, na.rm=T) #55 correct
