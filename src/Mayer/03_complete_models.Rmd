...
#quasi pois
d.qpois.mspe <- mean((c.d.resid.qpois)^2)
...
#quasi pois
r.qpois.mspe <- mean((c.r.resid.qpois)^2)

mspe_tab <- rbind(c(d.lm.mspe, d.glm.mspe),
                  c(r.lm.mspe, r.glm.mspe))#, r.sglmm.mspe))
#mspe_tab_count <- mspe_tab
colnames(mspe_tab) <- c("lin", "glm")#, "sglmm")
...
mod_dat <- For_R[,c("c_pre_dem12", "c_pre_rep12", "total_vep", "black_vep", "hisp_vep", "dem_incum", "rep_incum")]
